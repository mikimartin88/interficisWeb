                                            ...
                                            <div style="overflow: hidden;" class="portlet-body">
                                                ...
                                                while($row = $res->fetch_row()){
                                                    ...
                                                    while($filaProyecto = $resProyObj->fetch_row()){
                                                        ...
                                                        $gastadoTIC = $gastadoTIC + (int)$filaCostes[1];
                                                        $evaluacionPX2 = "SELECT * FROM evaluaciones WHERE idProyecto = ".$filaProyecto[0]." ORDER BY fecha";
                                                        $evaluacionPX = $mysqli->query($evaluacionPX2);
                                                        $evaluacionUltimaPX = $evaluacionPX->fetch_row();
                                                        $mediaProyecto = ($mediaProyecto + ((int)$evaluacionUltimaPX[2] + (int)$evaluacionUltimaPX[3] + (int)$evaluacionUltimaPX[4] + (int)$evaluacionUltimaPX[5] + (int)$evaluacionUltimaPX[6] + (int)$evaluacionUltimaPX[7])/6)/$iteracionObjetivo;
                                                        $iteracionObjetivo = $iteracionObjetivo + 1 ;
                                                    }
                                                    array_push($arrayCostesObj,$costeObj);
                                                    array_push($mediasEvalPorObj,$mediaProyecto);
                                                }
                                                ...
                                                array_push($arrayCostesObj,$gastadoTIC);
                                                array_push($nombre, "Coste anual TIC");
                                                ...
                                                $colores = array();
                                                foreach ($mediasEvalPorObj as $evalObj){
                                                    switch ($evalObj){
                                                        case ($evalObj < $umbralMedio):
                                                            array_push($colores, "red");
                                                            break;
                                                        case($evalObj>$umbralMedio&&$evalObj<$umbralOptimo):
                                                            array_push($colores, "yellow");
                                                            break;
                                                        case ($evalObj > $umbralOptimo):
                                                            array_push($colores, "green");
                                                            break;
                                                    }
                                                }
                                                $colores2 = array();
                                                array_push($colores2,"blue");
                                                if ($intPresTIC>$gastadoTIC){
                                                    array_push($colores2, "green");
                                                }else{
                                                ...
                                                array_push($nombre2,"Presupuesto TIC");
                                                ...
                                                <script type="text/javascript">
                                                    $(function () {
                                                        $('#container').highcharts({
                                                            ...
                                                            series: [{
                                                                name: 'Coste anual' ,
                                                                data: <?php 
                                                                      echo json_encode($arrayCostesObj) 
                                                                      ?>
                                                  ...
                                                  <script>
                                                    function llenarDatos(chart){
                                                        $.each(chart.series[0].data,function(i,data){
                                                            if (data.y==20000){
                                                                data.graphic.attr({fill:'red'});
                                                            }else{
                                                                data.graphic.attr({fill:'blue'});
                                                            }
                                                ...
                                                <script type="text/javascript">
                                                    $(function () {
                                                        ...
                                                        xAxis: {
                                                            categories: <?php echo json_encode($nombre2) ?>,
                                                            crosshair: true
                                                        },
                                                        yAxis: {
                                                            min: 0,
                                                ...
                                                <div class="container">
                                                    ...
                                                    <form class="pull-right" method="post" action="modificaUmbrales.php">
                                                        <fieldset>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input id="nombre" name="umbraloptimo" type="text" placeholder="" class="form-control input-md" required>
                                                                </div>
                                                            </div>


                                                            <div class="form-group col-md-4">
                                                                <label class="col-md-4 control-label" for="taDesc">Umbral medio: </label>
                                                                <div class="col-md-4">
                                                                    <input class="form-control" name="umbralmedio" placeholder="" required>
                                                                </div>
                                                            </div>
